...
export class HashrateChartPoolsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription(`See ${coinName} mining pool dominance visualized over time: see how top mining pools' share of total hashrate has fluctuated over time.`);
